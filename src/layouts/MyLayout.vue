  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated class="glossy">
      <q-toolbar>
        ...
        <q-toolbar-title>Groomers</q-toolbar-title>

        <div>Groomer version{{ $q.version }}</div>
      </q-toolbar>
    </q-header>

    <q-drawer v-model="leftDrawerOpen" bordered content-class="bg-grey-2">
      <q-list>
        <q-item-label header>Home Page</q-item-label>
        <q-item clickable v-close-menu :to="'/'">
          ...
          <q-item-section>
            ...
            <q-item-label caption>Click Here to Go Home</q-item-label>
          </q-item-section>
        </q-item>
